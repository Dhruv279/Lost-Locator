...
if (isset($_POST['submit']) && isset($_FILES['image'])) {
    ...
    if ($error === 0) {
        if ($img_size > 12500000) {
            ...
            header("Location: lost.php?error=$em");
            exit();
        } else {
            ...
            if (in_array($img_ex_lc, $allowed_exs)) {
                ...
                // Insert into Database with lost item details
                $sql = "INSERT INTO lost_data(image_url, item_name, lost_date, lost_place, product_description, contact_name, contact_no) 
